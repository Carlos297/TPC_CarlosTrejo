<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Viajes.aspx.cs" Inherits="templateApp.Viajes" %>
        ...
        <div class="row">
            ...
            <ItemTemplate>
                <div class="card">
                    ...
                    <asp:GridView class="table table-hover" ID="dgvViajes" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="dgvViajes_SelectedIndexChanged" OnRowCommand="dgvViajes_RowCommand" OnRowCancelingEdit="dgvViajes_RowCancelingEdit" OnRowEditing="dgvViajes_RowEditing" OnRowUpdating="dgvViajes_RowUpdating" Width="930px">
                        ...
                        <Columns>
                          ...
                          <%--  <asp:CommandField SelectText="Editar" ShowSelectButton="True" />--%>
                            ...
                            <asp:BoundField HeaderText="Id" DataField="IdViajes" ItemStyle-CssClass="oculto" HeaderStyle-CssClass="oculto">
                                <HeaderStyle CssClass="oculto"></HeaderStyle>

                                <ItemStyle CssClass="oculto"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField HeaderText="Codigo Viaje" DataField="CodVIaje" />
                            <asp:BoundField HeaderText="Terminal Origen" DataField="TerminalOrigen.NombreTerminal" />
                            <asp:BoundField HeaderText="Terminal Destino" DataField="TerminalDestino.NombreTerminal" />
                            <asp:BoundField HeaderText="Legajo" DataField="Chofer.Legajo"/>
                            <asp:BoundField HeaderText="Chofer" DataField="Chofer.Apellido"/>
                            <asp:BoundField HeaderText="Micro" DataField="Micro.Patente" />
                            <asp:BoundField HeaderText="Fecha Viaje" DataField="FechaViaje" />
                            <asp:BoundField HeaderText="Precio" DataField="Costo" />
