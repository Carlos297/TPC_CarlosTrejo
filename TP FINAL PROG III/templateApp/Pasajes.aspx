<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Pasajes.aspx.cs" Inherits="templateApp.Pasajes" %>
        ...
        <div class="row">
            ...
            <ItemTemplate>
                <div class="card">
                    ...
                    <asp:GridView class="table table-hover" ID="dgvPasajes" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="dgvPasajes_SelectedIndexChanged" OnRowCommand="dgvPasajes_RowCommand" OnRowCancelingEdit="dgvPasajes_RowCancelingEdit" OnRowEditing="dgvPasajes_RowEditing" OnRowUpdating="dgvPasajes_RowUpdating" Width="930px">
                        ...
                        <Columns>
                          ...
                          <%--  <asp:CommandField SelectText="Editar" ShowSelectButton="True" />--%>
                            ...
                            <asp:BoundField HeaderText="Id" DataField="IdBoleto" ItemStyle-CssClass="oculto" HeaderStyle-CssClass="oculto">
                                <HeaderStyle CssClass="oculto"></HeaderStyle>

                                <ItemStyle CssClass="oculto"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField HeaderText="Codigo Boleto" DataField="CodBoleto" />
                            <asp:BoundField HeaderText="Codigo de Viaje" DataField="Viaje.CodViaje" />
                            <asp:BoundField HeaderText="Precio Unitario" DataField="Viaje.Costo" />
                            <asp:BoundField HeaderText="Cantidad de Boletos" DataField="CantBoletos" />
