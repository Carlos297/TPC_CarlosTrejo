<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Terminales.aspx.cs" Inherits="templateApp.Terminales" %>
        ...
        <div class="row">
            ...
            <ItemTemplate>
                <div class="card">
                    ...
                    <asp:GridView class="table table-hover" ID="dgvTerminales" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="dgvTerminales_SelectedIndexChanged" OnRowCommand="dgvTerminales_RowCommand" OnRowCancelingEdit="dgvTerminales_RowCancelingEdit" OnRowEditing="dgvTerminales_RowEditing" OnRowUpdating="dgvTerminales_RowUpdating" Width="930px">
