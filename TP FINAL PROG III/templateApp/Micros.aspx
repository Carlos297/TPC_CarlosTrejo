<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Micros.aspx.cs" Inherits="templateApp.Micros" %>
        ...
        <div class="row">
            ...
            <ItemTemplate>
                <div class="card">
                    ...
                    <asp:GridView class="table table-hover" ID="dgvMicros" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="dgvMicros_SelectedIndexChanged" OnRowCommand="dgvMicros_RowCommand" OnRowCancelingEdit="dgvMicros_RowCancelingEdit" OnRowEditing="dgvMicros_RowEditing" OnRowUpdating="dgvMicros_RowUpdating" Width="930px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Id" DataField="IdMicro" ItemStyle-CssClass="oculto" HeaderStyle-CssClass="oculto">
                            ...
                            <asp:BoundField HeaderText="Fecha Fabricacion" DataField="FechaFabricacion" />
                            <asp:BoundField HeaderText="Cantidad de Asientos" DataField="CantAsientos" />
