<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="NuevaTerminalDestino.aspx.cs" Inherits="templateApp.NuevaTerminalDestino" %>
       ...
       <div class="contain">
        ...
        <div class="jumbotron">
            ...
            <div class="row">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Nueva Terminal Destino</h3>
                    </div>

                    <div>
                        <asp:TextBox class="form-control" placeholder="Codigo Terminal Destino" ID="txtCodTerminal" runat="server"></asp:TextBox>
                        
                    </div>
                    <div>
                        <asp:TextBox class="form-control" placeholder="Nombre Terminal Destino" ID="txtNomTermianl" runat="server"></asp:TextBox>
                   </div>
            ...
            <input type="text" class="form-control" placeholder="Estado" id="txtEstado">--%>
                ...
                <asp:Button class="btn btn-block btn-success" ref="TerminalesDestino.aspx" ID="btnGuardarTerminal" runat="server" OnClick="btnGuardar_Click" Text="GUARDAR">  </asp:Button>
